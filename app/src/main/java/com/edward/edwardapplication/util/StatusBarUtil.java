...
public class StatusBarUtil {
    ...
    public static void setImmersionStatus(Activity activity) {
    ...
    public static void switchActionBar(Activity activity) {
    ...
    public static void setStatusBarMode(Activity activity, boolean isTextDark, int colorId) {
        ...
        setAndroidNativeLightStatusBar(activity, isTextDark);
        //6.0以上，调用系统方法
    }
